...
> These results can obviously vary depending on different hardware or circumstances. By no means are they intended to be complete or used for anything other than perhaps noticing that the implementation gives particularly attention to performance. I think Quartz is awesome and does many more other things that we can't even do here.
